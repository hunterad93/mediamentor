...
st.title("Media mentor Chatbot - discuss Pathlabs knowledge bases with ChatGPT")
st.subheader("The chatbot uses knowledge from Guru cards and documentation from The Trade Desk, Google Ads, Facebook Ads, and Tapclicks. Ask questions about how to use these platforms and troubleshoot errors.")

# Dropdown to select the assistant
selected_assistant_id = assistants["guru-ttd-facebook-google-tapclicks(4o)"]
